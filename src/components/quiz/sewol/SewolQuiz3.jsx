          ...
          <div>
            <div className="quizBox">
              <div className="quizInBox">
                ...
                <p className="quizContent">
                  김지영 감독, 김어준 제작의 다큐멘터리 영화로 20억 3천만원의
                  시민 후원을 통해 3년간 제작되었다. 2018년 4월 12일 개봉되어
                  54만명이 관람하였다. 세월호 항적 분석, 생존자 진술, 적재 차량
                  CCTV 분석자료 등의 교차검증되는 사실을 근거로 가설을
                  제시하였다. 해당 영화가 주장한 'AIS(선박자동식별시스템) 조작
                  의혹'을 유가족이 검찰 세월호참사특별수사단에 수사의뢰하여 국내
                  23개의 AIS 기지국 및 해외 AIS 수집업체, 민간 선박의 AIS 데이터
                  등을 분석하였다.
                </p>
            ...
            {falseOpen && (
              <False
                text="오답입니다!"
                again="다시 풀어보세요"
                commentary="세월호 침몰 사고에 '다이빙벨'을 투입하는 과정을 다룬 다큐멘터리 영화이다. 세월호가 침몰한 이후 보름 간 승객 구조 방식을 두고 벌어졌던 대립의 상황을 담았다. 구조작업이 교착상태에 빠지자 알파잠수기술공사 대표 이종인이 대안으로 제시한 '다이빙벨' 투입에 대해 구조당국이 투입에 미온적, 투입 자체를 방해하여 제대로 구조활동을 펼칠 수 없었다는 내용을 다루고 있다."
